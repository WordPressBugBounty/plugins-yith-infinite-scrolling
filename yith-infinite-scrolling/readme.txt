...
= 2.12.0 = Released on 26 August 2026

* New: support for WooCommerce 11.1
* Update: YITH plugin framework

= 2.11.0 = Released on 12 August 2026

* New: support for WordPress 7.1
* Update: YITH plugin framework

= 2.10.0 = Released on 20 July 2026

* New: support for WooCommerce 11.0
* Update: YITH plugin framework

= 2.9.0 = Released on 18 June 2026

* New: support for WooCommerce 10.9
* Update: YITH plugin framework

= 2.8.0 = Released on 14 May 2026

* New: support for WooCommerce 10.8
* Update: YITH plugin framework

= 2.7.0 = Released on 31 March 2026
...
= 2.4.0 = Released on 4 December 2025

* New: support for WordPress 6.9
* New: support for WooCommerce 10.4
* Update: YITH plugin framework

= 2.3.1 = Released on 4 November 2025
* Update: YITH plugin framework
* Fix: issue while saving settings without WooCommerce installed

= 2.3.0 = Released on 16 October 2025
* Update: YITH plugin framework

= 2.2.0 = Released on 22 April 2025
...
* Fix: make sure to get full url from navigation link

= 1.27.1 = Released on 15 October 2024

* Fix: prevent 301 status when using parameter cache set to false

= 1.27.0 = Released on 17 September 2024

* New: support for WooCommerce 9.3
* Update: YITH plugin framework

= 1.26.0 = Released on 22 August 2024

* New: support for WooCommerce 9.2
* Update: YITH plugin framework

= 1.25.0 = Released on 17 July 2024
...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/yith-infinite-scrolling)
